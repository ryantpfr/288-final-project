...
void load_songs() {
	...
	//1
	unsigned char ImperialMarchNumNotes1 = 19;
	unsigned char ImperialMarchNotes1[19]     = {55, 55, 55, 51, 58, 55, 51, 58, 55, 0,  62, 62, 62, 63, 58, 54};
	unsigned char ImperialMarchDurations1[19] = {32, 32, 32, 20, 12, 32, 20, 12, 32, 32, 32, 32, 32, 20, 12, 32};
	oi_load_song(IMPERIAL_MARCH1, ImperialMarchNumNotes1, ImperialMarchNotes1, ImperialMarchDurations1);

	//2
	unsigned char ImperialMarchNumNotes2 = 3;
	unsigned char ImperialMarchNotes2[3]     = {51, 58, 55};
	unsigned char ImperialMarchDurations2[3] = {20, 12, 32};
	oi_load_song(IMPERIAL_MARCH2, ImperialMarchNumNotes2, ImperialMarchNotes2, ImperialMarchDurations2);
	...
	unsigned char BluesDurationD[14]  = {};
	oi_load_song(BLUES_D, BluesNotesD, BluesNumNotesD, BluesDurationD);
